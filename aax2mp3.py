...
def main():
    ...
    ap.add_argument('-c', '--clobber', default=False, action='store_true', help='overwrite existing files')
    ap.add_argument('-s', '--single', default=False, action='store_true', help="don't split into chapters")
    ap.add_argument('-t', '--test', default=False, action='store_true', help='test input file(s)')
    ap.add_argument('-v', '--verbose', default=False, action='store_true', help='extra verbose output')
